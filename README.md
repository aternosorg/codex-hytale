...
possible solutions. This is the implementation for Hytale logs including detectors, parsers and analysers to 
work with Hytale log files.
...
This is only an introduction to the Hytale implementation of [Codex](https://github.com/aternosorg/codex), for more
